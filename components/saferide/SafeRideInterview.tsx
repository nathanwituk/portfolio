  ...
  return (
    <section
      ...
      style={{
        ...
        paddingTop: "calc(var(--section-pt) + 100px)",
        paddingBottom: "calc(var(--section-pb) + 50px)",
        transition: "background-color 200ms ease",
      }}
    >
      <div
        ref={ref}
        className="max-w-[1280px] mx-auto flex flex-col gap-[75px]"
        style={{
          paddingLeft: "clamp(20px, 6.25vw, 80px)",
          paddingRight: "clamp(20px, 6.25vw, 80px)",
        }}
      >
        {/* Top row: label + title + quote card */}
        <div className="flex flex-col lg:flex-row items-start lg:items-center gap-[32px] lg:gap-[80px]">
          {/* Left: label + title */}
          <motion.div
            variants={stagger}
            initial="hidden"
          ...
          <motion.div
            ...
            initial="hidden"
            animate={inView ? "visible" : "hidden"}
            className="flex-1 rounded-[20px] min-w-0"
            style={{
        ...
        {/* Insight question — separate from the card */}
        <motion.div
          variants={fadeUp}
          initial="hidden"
          animate={inView ? "visible" : "hidden"}
        ...
        >
          ...
          <p
            ...
            style={{
              fontFamily: "var(--font-instrument-sans), 'Instrument Sans', sans-serif",
              fontSize: "clamp(1.875rem, 3vw, 2.3125rem)",
              letterSpacing: "-0.03em",
              color: "var(--text-primary)",
              transition: "color 200ms ease",
            }}
